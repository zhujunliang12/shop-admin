...
<head>
    ...
    <link href="<%=request.getContextPath()%>/js/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css"
          rel="stylesheet"/>
    <script src="<%=request.getContextPath()%>/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/js/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"></script>
    <script>
        //ajax全局设置
        $.ajaxSetup({
        ...
        <form id="" class="form-horizontal" style="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    ...
                    <img id="checkCodeImg" style="height:25.09px;" onclick="changeCheckCode()"
                         src="<%=request.getContextPath()%>/CheckCodeServlet"/>
